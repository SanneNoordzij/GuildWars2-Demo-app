...
namespace GuildWars2.Utils
{
	public static class NavigationService
	{
		...
		public static async Task PushModalRecreatePageAsync(BaseViewModel viewModel, Type pagetype, bool wrapInNavigation = true)
		{
			var view = (Page)Activator.CreateInstance(pagetype);
			view.BindingContext = viewModel;
			await Navigation.PushModalAsync(wrapInNavigation ? new NavigationPage(view) : view);
		}
